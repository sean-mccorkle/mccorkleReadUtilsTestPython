SERVICE = mccorklereadutilstestpython
SERVICE_CAPS = mccorkleReadUtilsTestPython
SPEC_FILE = mccorkleReadUtilsTestPython.spec
URL = https://kbase.us/services/mccorklereadutilstestpython
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
