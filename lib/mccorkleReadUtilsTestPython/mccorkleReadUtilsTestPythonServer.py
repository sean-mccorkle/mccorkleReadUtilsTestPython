...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'mccorkleReadUtilsTestPython'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from mccorkleReadUtilsTestPython.mccorkleReadUtilsTestPythonImpl import mccorkleReadUtilsTestPython
impl_mccorkleReadUtilsTestPython = mccorkleReadUtilsTestPython(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['mccorkleReadUtilsTestPython.filter_contigs_async'] = ['mccorkleReadUtilsTestPython', 'filter_contigs']
async_check_methods['mccorkleReadUtilsTestPython.filter_contigs_check'] = ['mccorkleReadUtilsTestPython', 'filter_contigs']
sync_methods['mccorkleReadUtilsTestPython.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'mccorkleReadUtilsTestPython'
        ...
        self.rpc_service.add(impl_mccorkleReadUtilsTestPython.filter_contigs,
                             name='mccorkleReadUtilsTestPython.filter_contigs',
                             types=[dict])
        self.method_authentication['mccorkleReadUtilsTestPython.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "mccorkleReadUtilsTestPython but no authentication header was passed"
                            raise err
